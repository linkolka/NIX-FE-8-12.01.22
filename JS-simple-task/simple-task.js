...
/*Сначала была идея перед объединением массивов проверить есть ли одинаковые значения у массива 1 и массива 2, но потом подумала, что это имеет смысл только в том случае, 
если подразумевается, что в внутри этих массивов нет повторяющихся значений
